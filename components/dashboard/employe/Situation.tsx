    ...
    return ( 
        <>
          <div className="w-full py-3 rounded-lg from-[15%] to-[85%] flex bg-gradient-to-r from-[#99F2C8] to-[#1F4037] ">
                  <div className="w-2/12 max-[1150px]:hidden  flex border-e-[1px] border-dashed border-[#424242] items-center justify-center flex-col">
                    <Image
                  ...
                  <div className="w-10/12 max-[1150px]:w-full flex justify-between">
                ...
                <div className=" flex gap-2 pe-3">
                  ...
                  <div className="flex max-[500px]:hidden flex-col justify-center items-end ms-3 me-2">
