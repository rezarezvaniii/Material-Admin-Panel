...
const StaticComponent = () => {
    ...
    return ( 
        <>
          <p className="text-xl font-normal text-[#878787]">Statistics</p>

              <div className="w-full rounded-md mt-2 gap-10 flex flex-col bg-white px-4 pt-6 shadow-[0_35px_60px_-15px_rgba(76,103,100,0.12)]">
              <LineChart
      xAxis={[
        {
          id: 'Years',
